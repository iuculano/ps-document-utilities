. "$PSScriptRoot\..\..\Public\Close-WordDocument.ps1"


Describe "Close-WordDocument" {

    Mock Open-WordDocument -MockWith {

        return [PSCustomObject]@{
            
            PSTypeName        = "ax.WordDocument"

            COMObjectWord     = "Valid (enough) data"
            COMObjectDocument = "Seems legit"
        }
    }
